...
void draw_text(const char *text, uint32_t x, uint32_t y, uint8_t fgcolor, uint8_t bgcolor);
void draw_window(const char *title, const char *footer, uint32_t x, uint32_t y, uint32_t width, uint32_t height);
